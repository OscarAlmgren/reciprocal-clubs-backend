...
import (
	...
	grpcHandlers "reciprocal-clubs-backend/services/governance-service/internal/handlers/grpc"
	httpHandlers "reciprocal-clubs-backend/services/governance-service/internal/handlers/http"
...
func main() {
	...
	// Initialize service
	governanceserviceService := service.NewService(repo, logger, natsClient, monitoringService)

	// Initialize handlers
	httpHandler := httpHandlers.NewHTTPHandler(governanceserviceService, logger, monitoringService)
	grpcHandler := grpcHandlers.NewGRPCHandler(governanceserviceService, logger, monitoringService)
